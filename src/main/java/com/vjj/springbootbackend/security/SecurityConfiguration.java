package com.vjj.springbootbackend.security;
 ...
 * @EnableWebSecurity
 * 
 * @SuppressWarnings("deprecation") public class SecurityConfiguration extends
 ...
 * http.authorizeRequests() .antMatchers("/api/v1/admin*").hasRole("ADMIN")
